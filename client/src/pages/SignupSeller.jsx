    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6 py-12 relative">
      ...
      <div className="w-full max-w-3xl bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden z-10 animate-scale-up">
        ...
        <div className="bg-brand-primary px-8 py-6 text-center border-b border-blue-700 flex flex-col items-center">
          ...
          <h2 className="text-xl font-bold text-white">Seller Registration Page</h2>
          <p className="text-xs text-slate-400 mt-1">
            Register as a seller (textile mill, weaver, trader, recycler). List waste stocklots and find buyers.
          </p>
        </div>
        ...
        <div className="p-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-2.5 rounded-lg border text-sm bg-slate-50 focus:outline-none focus:ring-2 ${
                      errors.password ? 'border-red-300 focus:ring-red-200' : 'border-slate-200 focus:border-brand-primary focus:ring-sky-50'
                    }`}
                    {...register('password')}
                  />
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-4 border-t border-slate-100">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full sm:w-auto bg-brand-primary hover:bg-sky-600 text-white font-bold px-8 py-3.5 rounded-lg text-sm transition-all shadow-lg shadow-sky-500/20 flex items-center justify-center space-x-2 disabled:opacity-50"
              >
                {loading ? (
                  <>
                    <Loader2 className="h-5 w-5 animate-spin" />
                    <span>Creating Seller...</span>
                  </>
                ) : (
          ...
          <div className="mt-8 border-t border-slate-100 pt-6 text-center">
            <span className="text-[11px] text-slate-400 inline-flex items-center space-x-1.5 justify-center">
              ...
              <span>Verified Seller B2B Gated Network</span>
            </span>
          </div>
        </div>
      </div>
