    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-6 py-12 relative">
      ...
      <div className="w-full max-w-3xl bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden z-10 animate-scale-up">
        ...
        <div className="bg-brand-primary px-8 py-6 text-center border-b border-blue-700 flex flex-col items-center">
          ...
          <h2 className="text-xl font-bold text-white">Buyer Registration Page</h2>
          <p className="text-xs text-slate-400 mt-1">
            Register as a buyer (recycling mill, exporter, trader). Search directory lists and contact verified sellers.
          </p>
        </div>
        ...
        <div className="p-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    placeholder="e.g. EcoFibre Waste Recyclers"
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="EXPORTER">EXPORTER (Surplus Buyer)</option>
                    <option value="OTHER">OTHER (Apparel Manufacturer)</option>
                  </select>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    type="email"
                    placeholder="e.g. suresh@ecofibre.com"
                    className={`w-full px-4 py-2.5 rounded-lg border text-sm bg-slate-50 focus:outline-none focus:ring-2 ${
            ...
            {/* Address (Full-width) */}
            <div>
              <label className="block text-[11px] font-semibold text-slate-500 uppercase mb-1">Office Address</label>
              <textarea
                rows={2}
          ...
          <div className="mt-8 border-t border-slate-100 pt-6 text-center">
            <span className="text-[11px] text-slate-400 inline-flex items-center space-x-1.5 justify-center">
              ...
              <span>Verified Buyer B2B Gated Network</span>
            </span>
          </div>
        </div>
      </div>
